    ...
    public static partial class SqlMapperExtensions
    {
        ...
        private static string GetTableName(Type type)
        {
            ...
            if (!TypeTableName.TryGetValue(type.TypeHandle, out name))
            {
                ...
                var tableattr = type.GetCustomAttributes(false).SingleOrDefault(attr => attr.GetType().Name == "TableAttribute");
                if (tableattr != null)
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var updated = connection.Execute(sb.ToString(), entityToUpdate, transaction, commandTimeout, null);
            return updated > 0;
        }
        ...
        public static bool Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var deleted = connection.Execute(sb.ToString(), entityToDelete, transaction, commandTimeout, null);
            return deleted > 0;
        }
        ...
        public static bool DeleteAll<T>(this IDbConnection connection, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var deleted = connection.Execute(statement, null, transaction, commandTimeout, null);
            return deleted > 0;
        }
...
public partial class SqlServerAdapter : ISqlAdapter
{
    public long Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, String tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var r = connection.Query("select @@IDENTITY id", entityToInsert, transaction: transaction, commandTimeout: commandTimeout, buffered: true, commandType: null);
...
public partial class PostgresAdapter : ISqlAdapter
{
    public long Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, String tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var results = connection.Query(sb.ToString(), entityToInsert, transaction, true, commandTimeout, null).ToList();
