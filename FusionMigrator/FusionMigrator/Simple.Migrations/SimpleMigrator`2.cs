...
namespace SimpleMigrations
{
        ...
        where TMigrationBase : IMigration<TConnection>
    {
        ...
        /// </summary>
        public IList<MigrationData> Migrations { get; private set; }
        ...
        protected virtual void FindAndSetMigrations()
        {
            ...
            var migrationBaseTypeInfo = typeof(TMigrationBase);
            ...
            if (firstDuplicate != null)
                throw new MigrationLoadFailedException($"Found more than one migration with version {firstDuplicate.Key}");
        ...
        protected virtual TMigrationBase CreateMigration(MigrationData migrationData)
        {
            ...
            try
            {
                instance = (TMigrationBase)Activator.CreateInstance(migrationData.TypeInfo);
            }
            catch (Exception e)
            {
