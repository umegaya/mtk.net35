...
namespace SimpleMigrations
{
    ...
    public class MigrationData
    {
        ...
        public MigrationData(long version, string description, Type typeInfo)
        {
            ...
            var descriptionPart = (String.IsNullOrEmpty(this.Description) || this.Description.Trim().Length == 0) ? "" : $" ({this.Description})";
